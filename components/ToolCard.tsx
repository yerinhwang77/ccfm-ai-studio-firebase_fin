  ...
  return (
    ...
    >
      ...
      <div className="absolute top-3 left-3 z-10">
         {tool.isManaged && (
           <div className="bg-amber-50 text-amber-600 p-1.5 rounded-lg shadow-sm border border-amber-100" title="관리자 전용 툴">
      ...
      <div className="absolute top-3 right-3 z-10 opacity-0 group-hover:opacity-100 transition-opacity">
        <div className="bg-gray-900 text-white text-[10px] px-2 py-1 rounded-full flex items-center gap-1 shadow-sm">
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 pt-8">
        ...
        <div 
          onClick={(e) => handleLinkClick(e, tool.linkUrl)}
      ...
      <div className="p-4 pt-0 mt-auto w-full">
        {tool.manualUrl ? (
          <button
            onClick={(e) => handleLinkClick(e, tool.manualUrl)}
